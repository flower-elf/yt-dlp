...
def create_parser():
    ...
    network.add_option(
        '--explicit-allow-list','--exp-allow', metavar='EAllowedURL', dest='explicit_allow_list', default=None,
    ...
    network.add_option(
        '--wildcard-allow-list','--wild-allow', metavar='WAllowedURL', dest='wildcard_allow_list', default=None,
